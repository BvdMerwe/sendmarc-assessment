...
class TaskFighterTest extends TestCase
{
    ...
    public function test_taskfighter_tick_normal_task() {
        ...
        $this->test_taskfighter_tick_normal($tf);
        $tf->priority = -1;
        $this->test_taskfighter_tick_normal_negative_priority($tf);

        $tf->dueIn = -1;
        $this->test_taskfighter_tick_normal_passed_due($tf);

        //increase priority a lot
        for ($i = 0; $i < 100; $i++) {
            $tf->tick();
        }
        $this->test_taskfighter_tick_normal_priority_over_100($tf);
    }
    public function test_taskfighter_tick_normal($tf) {
        fwrite(STDERR, print_r(__FUNCTION__.PHP_EOL, TRUE));
    ...
    public function test_taskfighter_tick_normal_negative_priority($tf) {
        fwrite(STDERR, print_r(__FUNCTION__.PHP_EOL, TRUE));
    ...
    public function test_taskfighter_tick_normal_passed_due($tf) {
        fwrite(STDERR, print_r(__FUNCTION__.PHP_EOL, TRUE));
    ...
    public function test_taskfighter_tick_normal_priority_over_100($tf) {
        fwrite(STDERR, print_r(__FUNCTION__.PHP_EOL, TRUE));
